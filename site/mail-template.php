                                ...
                                <table cellspacing=\"0\" cellpadding=\"0\" style=\"width: 750px;\">
                                    <tr>
                                        <td style=\"vertical-align: top; padding: 20px; font-family: verdana, arial;\">
											...
											$body .= JText::_('COM_EPAY_PAYMENT_APPROVED');
											
											$body .= "</h1>
                                            
											<table cellspacing=\"0\" cellpadding=\"0\">
                                                <tr>
                                                    <td style=\"font-size: 14px; padding: 4px; font-family: verdana, arial;\" colspan=\"2\"><b>";
													$body .=  JText::_('COM_EPAY_ORDER_INFORMATION'); 
													$body .= "</b></td>
                                                </tr>";
												...
												$body .= "<tr>
													...
													$body .=  JText::_('COM_EPAY_COMPANY'); 
													$body .= "</td>
                                                    <td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; width: 350px; font-family: verdana, arial; font-size: 13px;\">[company]</td>
                                                </tr>";
												}
												
												$body .= "<tr>
                                                    <td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
													$body .=  JText::_('COM_EPAY_DATE_TIME'); 
													$body .= "</td>
                                                    <td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; width: 350px; font-family: verdana, arial; font-size: 13px;\">[date] [time]</td>
                                                </tr>
												<tr>
                                                    <td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
													$body .=  JText::_('COM_EPAY_TRANSACTION_ID'); 
													$body .= "</td>
                                                    <td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; width: 350px; font-family: verdana, arial; font-size: 13px;\">[tid]</td>
                                                </tr>
                                                <tr>
                                                    <td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
													$body .= JText::_('COM_EPAY_INVOICE');
													$body .= "</td>
												...
												<tr>
                                                    <td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
													$body .= JText::_('COM_EPAY_TRANSACTION_FEE'); 
													$body .= "</td>
                                                    <td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">
														[transfee] [cur]
													</td>
												...
												if($params->get('epay_showemail') == 1 or $params->get('epay_showname') == 1 or $params->get('epay_showaddress') == 1 or $params->get('epay_showcountry') == 1 or $params->get('epay_showphone') == 1 or $params->get('epay_showcomment') == 1){
													$body .= "<tr>
														...
														$body .= JText::_('COM_EPAY_CUSTOMER_INFORMATION'); 
														$body .= "</b></td>
													</tr>";
												}
													...
													if($params->get('epay_showemail') == 1){
														...
														$body .= "<tr>
															...
															$body .= JText::_('COM_EPAY_EMAIL'); 
															$body .= "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; width: 350px; font-family: verdana, arial; font-size: 13px;\">[cemail]</td>
													...
													if($params->get('epay_showname') == 1){
														...
														$body .= "<tr>
															<td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
															$body .= JText::_('COM_EPAY_NAME');
															$body .= "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">[cname]</td>
													...
													if($params->get('epay_showaddress') == 1){
														...
														$body .= "<tr>
															...
															$body .= JText::_('COM_EPAY_ADDRESS');
															$body .= "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">[caddress]</td>
													...
													if($params->get('epay_showcountry') == 1){
														...
														$body .= "<tr>
															<td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
															$body .= JText::_('COM_EPAY_COUNTRY');
															$body .= "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">[ccountry]</td>
													...
													if($params->get('epay_showphone') == 1){
														...
														$body .= "<tr>
															<td style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">";
															$body .= JText::_('COM_EPAY_PHONE'); 
															$body .= "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">[cphone]</td>
													...
													if($params->get('epay_showcomment') == 1){
														...
														$body .= "<tr>
															<td valign=\"top\" style=\"background-color: #EEEEEE; border-right: 3px solid #FFFFFF; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px; vertical-align: top;\">";
															$body .= JText::_('COM_EPAY_COMMENT'); 
															$body .=  "</td>
															<td style=\"background-color: #EEEEEE; border-bottom: 3px solid #FFFFFF; padding: 4px; font-family: verdana, arial; font-size: 13px;\">[ccomment]</td>
											...
											$body .= "<table cellspacing=\"0\" cellpadding=\"0\">
                                                <tr>
                                                    ...
                                                    <td style=\"vertical-align: top; font-size: 11px; color: #000000; font-family: verdana, arial; font-size: 12px;\">
														...
														$body .= JText::_('COM_EPAY_SECURE_PAYMENT');
														$body .= "</div>";
                                                        $body .= JText::_('COM_EPAY_EPAY_PAYMENT_SOLUTIONS');
                                                    $body .= "</td>  
                                                </tr>
                                            </table>
                                        </td>
